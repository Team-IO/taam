...
public class ContainerLogisticsCart extends Container {
	 protected EntityLogisticsCart entity;

	public ContainerLogisticsCart(InventoryPlayer inventoryPlayer,
			EntityLogisticsCart entity) {
		this.entity = entity;
