...
import net.teamio.taam.logistics.IVehicle;
import net.teamio.taam.logistics.InBlockRoute;
import net.teamio.taam.logistics.LogisticsManager;
import net.teamio.taam.logistics.LogisticsUtil;
import net.teamio.taam.logistics.PredictedInventory;
import net.teamio.taam.logistics.Route;
import net.teamio.taam.logistics.StationGraph;
...
public class EntityLogisticsCart extends Entity implements IVehicle {
	...
	public boolean interactFirst(EntityPlayer player) {
		if(player.isSneaking() && TaamUtil.playerHasWrench(player)) {
			ItemStack stack = new ItemStack(TaamMain.itemLogisticsCart);
			TaamUtil.tryDropToInventory(player, stack, posX, posY, posZ);
			this.setDead();
		} else {
